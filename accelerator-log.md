...
```json
{
  ...
  "appWorkloadURL" : "https://where-for-dinner.alberto-test.tapdemo.vmware.com",
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"cacheName":"cache-where-for-dinner","appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"appWorkloadURL":"https://where-for-dinner.alberto-test.tapdemo.vmware.com","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input8082452652086423018, --data-values-file, /tmp/accelerator-options9501914867988703770.json, --output-files, /tmp/ytt-output9607549285331848370]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"cacheName":"cache-where-for-dinner","appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"appWorkloadURL":"https://where-for-dinner.alberto-test.tapdemo.vmware.com","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input2926444669608086411, --data-values-file, /tmp/accelerator-options16764140412914595440.json, --output-files, /tmp/ytt-output11098954846692550738]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","dbType":"h2","rabbitMQName":"rmq-where-for-dinner","enableCloudEvents":false,"devDefaultAccountPassword":"letseat","enableSecurity":false,"cacheName":"cache-where-for-dinner","appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"enableDefaultDevAccount":true,"appWorkloadURL":"https://where-for-dinner.alberto-test.tapdemo.vmware.com","artifactId":"where-for-dinner","serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"my-apps","cacheType":"inmemCache"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input1144461042251648635, --data-values-file, /tmp/accelerator-options229826314742343474.json, --output-files, /tmp/ytt-output11976478802754447135]
